	...
	<div class="row">
		<div class="col-4">
			<form class="form-control" method="post">
				<input type="hidden" name="id""> <label for="id">Username</label>
				<input type="text" name="username" class="form-control"> <label
					for="password">Password</label> <input type="password"
					name="password" class="form-control"> <label for="email">Email</label>
				<input type="text" name="email" class="form-control"> <label
