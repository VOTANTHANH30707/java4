<%@ page language="java" contentType="text/html; charset=UTF-8" 
	pageEncoding="UTF-8"%>
<footer class="bg-secondary-subtle pt-5 pb-3 tm-text-gray tm-footer mt-5">
	<div class="container-fluid tm-container-small"> 
		<div class="row">
			<div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
				<h3 class="tm-text-primary mb-4 tm-footer-title">Online Entertaiment</h3>
				<p>
		...
		<div class="row">
			<div class="col-lg-8 col-md-7 col-12 px-5 mb-3">Online Entertaiment 2020</div>
